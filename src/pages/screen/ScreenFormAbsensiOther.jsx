...
import FormAbsensiOther from '../../components/organisms/FormAbsensiOther';

const ScreenFormAbsensiOther = ({navigation}) => {
  return (
    <View style={{height: '100%', backgroundColor: Color.green}}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.wrapperForm}>
          <FormAbsensiOther navigation={navigation} />
        </View>
      </ScrollView>
    </View>
  );
...
export default ScreenFormAbsensiOther;
