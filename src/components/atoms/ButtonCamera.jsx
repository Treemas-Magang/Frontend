...
const ButtonCamera = () => {
  ...
  return (
    <View>
      {loading ? ( // Tampilkan ActivityIndicator saat loading aktif
        <ActivityIndicator size="large" color={Color.green} />
      ) : imageCamera ? ( // Tampilkan gambar jika sudah tersedia
        <Image source={{ uri: imageCamera.uri }} style={{ height: 300, width: 190 }} />
      ) : (
