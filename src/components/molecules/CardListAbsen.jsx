  ...
  return (
    ...
    <View style={styles.wrapper}>
        <View style={styles.wrap}>
            ...
            <Text style={styles.alamat} numberOfLines={5}>jl. boulevard graha raya blok N1  no.21, RT.4/RW.8, Paku jaya, Kec. Serpong utara, Kota Tangerang Selatan, Banten 15326, Indonesia</Text>
        </View>
        <View style={styles.wrap}>
